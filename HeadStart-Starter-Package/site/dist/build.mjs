...
await mkdir('public');
for (const path of ['index.html', 'plugin.html', 'plugin-setup.js', 'plugin-setup.css', 'auth.html', 'auth.js', 'handoff.js', 'auth.css', 'operations.html', 'operations.js', 'telemetry.js', 'operations.css', 'recipes.html', 'recipes.js', 'recipes.css', 'submissions.html', 'submissions.js', 'submissions.css', 'styles.css', 'app.js', 'astra-action.js', 'detail.js', 'brief-store.js', 'brief-collection.js', 'brief-collection.css', 'signup.js', 'catalog.js', 'gauntlet-prompt.js', 'retrieval-ui.js', 'retrieval-ui.css', 'discovery.js', 'reviewed-systems.js', 'NOTICES.md', 'assets', 'downloads', 'provenance']) {
