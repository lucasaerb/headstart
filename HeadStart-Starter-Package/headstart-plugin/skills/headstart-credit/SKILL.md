---
name: headstart-credit
description: Preserve applicable source and asset notices and record local provenance for copied, adapted or forked game code.
---

# Credit

Read [evidence and rights](../../references/evidence-and-rights.md). Identify the selected source revision, included files, authors, code and asset license evidence, notices and modifications. Preserve exact required notice content instead of replacing it with an AI-written summary. Do not assume a repository-level license covers every asset or external dataset.
