...
Follow the [local integration execution contract](../../references/local-integration-workflow.md). Use a separate worktree for the authorized patch. Record applying/applied/failed/cancelled stages honestly; retain partial changes for review and scoped reversal.
