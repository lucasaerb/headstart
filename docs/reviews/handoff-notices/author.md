...
- Fresh catalog initialization creates the shared rights policy schema before any protected action; regression passes without explicitly preparing a policy table in the fresh database.
