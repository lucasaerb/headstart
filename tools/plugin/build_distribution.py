...
REQUIRED = {'.codex-plugin/plugin.json', 'plugin.json', 'mcp.json', 'README.md',
            'scripts/catalog_mcp.py', 'scripts/inspect_project.py', 'scripts/live_catalog.py', 'scripts/configure_connection.py',
...
def allowed(path: str) -> bool:
    ...
    if len(parts) == 2 and parts[0] == 'scripts':
        return parts[1] in {'catalog_mcp.py', 'inspect_project.py', 'live_catalog.py', 'configure_connection.py'}
